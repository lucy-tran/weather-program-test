 ...
 */
public class WidgetTest1 {
// Works for Temperature widget with custom data
    ...
    private WidgetTest1() {
        ...
        GraphicsText helpText = new GraphicsText("Click anywhere to generate the test data", 0, 580);
